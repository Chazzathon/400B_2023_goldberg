...
import pandas as pd
from BinningAlgorithm import bin_xy
...
''''Bonus function to find the velocity dispersion as a function of radius.
...
def velo_disp(V,R):
    ...
    #initialize r_list and dispersion_list
    r_list=[]
    dispersion_list=[]
...
def main():
    ...
    n_bins=1000
    new_r,new_v=bin_xy(rn[:,0],vn[:,1],n_bins)
    ...
    r_list,dispersion_list=velo_disp(V,R)
